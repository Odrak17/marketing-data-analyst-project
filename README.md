...
# Contexte du projet: 
Avant tout il sied de signaler que le dataset sur lequel porte notre travil a été téléchargé sur Maven Analytics à des fins d'apprentissage. Ce projet  d'analyse de données est un projet dans le secteur marketing qui vise à comprendre le comportements des clients et la performance des différentes campagnes marketing.
...
- Identifier les anomalies sur les données (valeurs manquantes, les outliers, doublons,...) et définir des règles de nettoyage adaptées.

* Objectif 2 : Analyse des facteurs influençant les achats en ligne
- Identifier les variables spécifiquement liées au nombre d'achats et aux montants dépensés.
- Analyser les relations entre variables démographiques et comportementales
...
# Fonctionnaités / Particularitéss du projet :
